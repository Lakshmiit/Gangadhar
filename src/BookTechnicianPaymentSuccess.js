...
// useEffect(() => {
//     fetch(`https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/BookTechnician/GetBookTechnician/${id}`)
//       .then((res) => res.json())
//       .then((data) => {
...
//           "https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/BookTechnician/bookTechnicianEdit",
//           {
//             method: "POST",
