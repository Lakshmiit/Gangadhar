...
//             pincode you want to serve. Checked pincodes are sent along with your
//             submission when you click "Submit for approval".
//           </p>
...
//                           title="Move down"
//                           disabled={
//                             index === readyToSubmitCategories.length - 1
//                           }
//                           onClick={() => moveCategory(index, 1)}
//                         >
//                           &darr;
...
const VendorPreviewPage = () => {
  ...
  // Free-text note the vendor can leave alongside this submission — e.g.
  // to flag that they have more products they'd like to add later. Purely
  // optional; sent as "vendorNote" alongside the rest of the payload on
  // submit, and cleared once the submission goes through.
  ...
  const handleSubmitFinal = async () => {
    ...
    const hasExistingRecord = !!myProducts?.id;
    const trimmedNote = vendorNote.trim();
        ...
        <div className="card-body p-4">
          ...
          {!pendingCart || pendingProductCount === 0 ? (
            ...
            <>
              ...
              {/* ---- Optional note the vendor can leave before submitting,
                  e.g. to flag more products they'd like to add later. ---- */}
              <div className="mt-3">
                <label
                  htmlFor="vendorNote"
                ...
                <textarea
                  ...
                  className="form-control"
                  rows={3}
                  placeholder="Want to add more products? Let us know here and we'll follow up with you."
                  value={vendorNote}
