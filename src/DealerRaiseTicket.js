...
//     useEffect(() => {
//       const apiUrl = `https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/RaiseAQuote/GetRaiseAQuoteDetailsByid?raiseAQuotetId=${raiseTicketId}`;
...
//           try {
//             const response = await fetch(`https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/RaiseTicket/GetTicket/${raiseTicketId}`);
//             if (!response.ok) {
...
//       const response = await fetch(`https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/RaiseTicket/${raiseTicketId}`, {
//         method: 'PUT',
//         headers: {
...
//   };
//   try {
//     const response = await fetch(`https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/RaiseAQuoteByDealer/CreateRaiseAQuoteByDealer`, {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json',
//       },
